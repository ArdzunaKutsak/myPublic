...
export function Icons({value}: IconsI) : JSX.Element {
 
    switch (value) {
      case "Комментарии":
        return <svg className={styles.icon} width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "Сохранить":
        return <svg className={styles.icon}  width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "Пожаловаться":
        return <svg className={styles.icon}  width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      case "Поделиться":
        return <svg className={styles.icon}  width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
